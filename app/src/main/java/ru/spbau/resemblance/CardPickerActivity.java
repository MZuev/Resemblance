...
public class CardPickerActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        suggestion.setText(callingIntent.getStringExtra(GameIntermediateActivity.SUGGESTION_PARAM));
        setTitle(callingIntent.getStringExtra(GameIntermediateActivity.TITLE_PARAM));

        List <Long> cardIds = new ArrayList<>();
        long[] cardsArr = callingIntent.getLongArrayExtra(GameIntermediateActivity.OUR_CARDS_PARAM);
